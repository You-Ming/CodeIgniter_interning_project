...
window.onload = function() {
    ...
    $(document).ready(function(){
            ...
            $('#txt_user_username').focus(function(){
                $('.user_error2').text('');
                $(this).css("border-color","#006cff");
            })
        ...
        $("#txt_user_username").blur(function(){
            if($("#txt_user_username").val()==""){
                $('.user_error2').text('');
            }else if($("#txt_user_username").val().indexOf(' ')>=0){
        ...
        $("#psw_user_password2").keyup(function(){
            ...
            <div id='admin_user_create'>
              ...
              <?php $attribute = array('id' => 'formSetUser','class' => 'form-horizontal','role' => 'form');?>
              <?php echo form_open('',$attribute)?>

                <div class="form-group">
                  <label for="txt_user_name" class="col-sm-2 control-label">使用者名稱</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="txt_user_name" placeholder="請輸入名稱"><span class="user_error1"></span>
                  </div>
                </div>

                <div class="form-group">
                  <label for="txt_user_username" class="col-sm-2 control-label">帳號</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="txt_user_username" placeholder="請輸入帳號"><span class="user_error2"></span>
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="password" class="form-control" id="psw_user_password" placeholder="請輸入密碼"><span class="user_error3"></span>
                  </div>
                </div>
