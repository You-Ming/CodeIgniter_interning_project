    ...
    $("#txt_banner_name").blur(function(){
        if($("#txt_banner_name").val()==""){
            ...
            <div id='admin_banner_create'>
              ...
              <?php $attribute = array('id' => 'formSetBanner', 'class' => 'form-inline', 'role' => 'form'); ?>
              <?php echo form_open('',$attribute) ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="bannerName" class="form-control" id="txt_banner_name" placeholder="請輸入橫幅名稱"><span class="banner_error1" style="color:red"></span><br>
                </div><br><br>
                ...
                <input type="button" class="btn btn-primary btn-sm" id="btn_create_banner_back" value="取消" onclick="window.location.href='/admin/home'">
              </form>
            </div>
