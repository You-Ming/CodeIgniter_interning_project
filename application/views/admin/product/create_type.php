        ...
        if($("#txt_productType_name").val()==""){
            ...
            <div id='admin_productType_create'>
              <h3>新增產品分類</h3><br>
                ...
                <?php $attribute = array('id' => 'formSetPorductType', 'class' => 'form-inline', 'role' => 'form'); ?>
                <?php echo form_open('',$attribute) ?>

                  <div class="form-group">
                    <label for="txt_productType_name" class="control-label">產品分類名稱:</label>
                    <input type="text" name="txt_productType_name" class="form-control" id="txt_productType_name" placeholder="請輸入產品分類名稱"><span class="user_error1"></span>
                  </div>
                  <br><br>
