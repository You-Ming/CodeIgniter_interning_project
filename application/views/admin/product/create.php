            ...
            <div id='admin_product_create'>
              ...
              <?php echo form_open_multipart('',$attribute) ?>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="productName" class="form-control" id="txt_product_name" placeholder="請輸入產品名稱"><span class="product_error1" style="color:red"></span><br>
                </div><br><br>
...
<?php endforeach?>
                ...
                <script>
                  ...
                  CKEDITOR.replace( 'textarea_set_product_desc', {
                    width:1000,
                  });
                </script>

                <input type="button" class="btn btn-primary btn-sm" id="btn_create_product" value="送出">
                <input type="button" class="btn btn-primary btn-sm" id="btn_create_product_back" value="取消" onclick="window.location.href='/admin/product'">
              </form>
            </div>
